...
loaded_model = joblib.load('C:/Users/ASUS/Downloads/AppHeartDisease/AppHeartDisease/AppHeartDisease/model_classifier_rf.pkl')
...
def home():
    ...
    if request.method == "POST":
        ...
        if prediction_results == 1:
            str_prediction = 'Anda sakit jantung!'
        elif prediction_results == 0:
            str_prediction = 'Selamat anda sehat!'
